 ...
 * {@link AbstractQueueRequestHandler}. The QueueReponseCreator is the runner of the 
 * {@link IResponder} associated with the {@link IQueueService} and is 
 * responsible for creating the correct type of {@link AbstractQueueRequestHandler}. 
 *
 */
