 ...
 * </pre>
 *
 * This package deals with actions which the acquisition server may be instructed to do.
 * It defines the interface of the server to various client types, Java, VB and javascript.
 *
